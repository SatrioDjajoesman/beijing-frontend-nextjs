...
const BUTTON_BASE =
  "overflow-hidden backdrop-blur-sm border border-l-0 border-r-0 " +
  "font-light " +
...
export function buttonToneClass(active: boolean): string {
  return active
    ? "bg-gradient-to-t from-blue-600/80 to-blue-800/60 border border-b-blue-800/70 border-t-blue-300/80 border-x-0 text-white " +
        ...
        "hover:border-b-blue-900/50 hover:border-t-blue-200/80 transition-colors duration-150 ease-in-out"
    : "bg-gradient-to-t from-zinc-600/90 to-zinc-800/50 border border-b-zinc-800/70 border-t-zinc-300/80 border-x-0 text-white " +
